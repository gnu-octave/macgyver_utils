...
anzahl      = 25e6 #Vektorlänge der Zufallszahlen
durchlaeufe = 2
V_soll      = 3.3 #V
###
...
volt.adc       		= 1e-9;
prozent.adc	  	= volt.adc/V_soll;
verteilung.adc 		= "r";

prozent.einbruch 	= 10/100;#10% Spannungseinbruch
verteilung.einbruch 	= "n";
...
## Spannungseinbruch ist nur negativ

u.einbruch = (abs(u.einbruch-1) .* (-1)) + 1;

##

p = (u.rauschen .* u.adc) ./u.einbruch;
k = p * V_soll;
###
